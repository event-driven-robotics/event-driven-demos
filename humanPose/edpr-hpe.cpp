...
#include <vector>
#include <string>
#include "hpe_msgs/NC_humanPose.h"
...
class EDPR_HPE : public RFModule
{
...
public:
    bool configure(yarp::os::ResourceFinder &rf) override
    {
        ...
        setName((rf.check("name", Value("/edpr_hpe")).asString()).c_str());
        ...
        edpr_logo = cv::imread("/usr/local/src/event-driven-demos/humanPose/edpr_logo.png");
        ...
        cv::namedWindow("edpr-hpe", cv::WINDOW_NORMAL);
        cv::resizeWindow("edpr-hpe", cv::Size(640, 480));

        
        // set-up ROS interface
        ros_node = new yarp::os::Node("/HPE");
